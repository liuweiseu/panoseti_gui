...
%         IntensmeanQ3=[IntensmeanQ3 mean(meanimage(9:16,9:16),[1 2])];
    ...
    daczeropoint1=0;threshpeak=0.25;
     if loopgaincnt==1
    peaksrefdacQ0=findpelevel(phdrefQ0,dactab,daczeropoint1,threshpeak,-8);
     peaksrefdacQ1=findpelevel(phdrefQ1,dactab,210,0.3,-8);
      peaksrefdacQ2=findpelevel(phdrefQ2,dactab,daczeropoint1,threshpeak,-8);
       peaksrefdacQ3=findpelevel(phdrefQ3,dactab,210,threshpeak,-8);
     end
     ...
     subplot(2,2,2)
                hold on
     plot([peaksrefdacQ1(1) peaksrefdacQ1(1)] , yl,'k--')
     plot([peaksrefdacQ1(2) peaksrefdacQ1(2)] , yl,'k--')
     plot([peaksrefdacQ1(3) peaksrefdacQ1(3)] , yl,'k--')
     ...
     subplot(2,2,3)
                hold on
     plot([peaksrefdacQ2(1) peaksrefdacQ2(1)] , yl,'k--')
     plot([peaksrefdacQ2(2) peaksrefdacQ2(2)] , yl,'k--')
     plot([peaksrefdacQ2(3) peaksrefdacQ2(3)] , yl,'k--')
     ...
     subplot(2,2,4)
                hold on
     plot([peaksrefdacQ3(1) peaksrefdacQ3(1)] , yl,'k--')
     plot([peaksrefdacQ3(2) peaksrefdacQ3(2)] , yl,'k--')
     plot([peaksrefdacQ3(3) peaksrefdacQ3(3)] , yl,'k--')
...
%              
            ...
            if numel(peakstestdacQ1)>=1
                peaksepQ1=dactab(1)-1+peakstestdacQ1(1)-Q0refdac-(peaksrefdacQ1(1)-peaksrefdacQ0(1));
...
%             peakstestdacQ3=peaksrefdacQ3(1)-1+minind;
    ...
    %%%%put quad at right DAC 1pe and take screenshot of image and gain map
     ...
     quaboconfig(indexdac,1+1)={['0x' dec2hex(Q0refdac+offdac)]};
      quaboconfig(indexdac,2+1)={['0x' dec2hex(peaksrefdacQ1(1) + Q0refdac-peaksrefdacQ0(1)+offdac )]};
      quaboconfig(indexdac,3+1)={['0x' dec2hex(peaksrefdacQ2(1)+ Q0refdac-peaksrefdacQ0(1)+offdac)]};
       quaboconfig(indexdac,4+1)={['0x' dec2hex(peaksrefdacQ3(1)+ Q0refdac-peaksrefdacQ0(1)+offdac)]};
    
         disp(['Sending Maroc comm...DAC1 Q0:' num2str(Q0refdac+offdac)])
          disp(['Sending Maroc comm...DAC1 Q1:' num2str(peaksrefdacQ1(1) + Q0refdac-peaksrefdacQ0(1)+offdac )])
           disp(['Sending Maroc comm...DAC1 Q2:' num2str(peaksrefdacQ2(1)+ Q0refdac-peaksrefdacQ0(1)+offdac)])
            disp(['Sending Maroc comm...DAC1 Q3:' num2str(peaksrefdacQ3(1)+ Q0refdac-peaksrefdacQ0(1)+offdac)])
        sendconfig2Maroc(quaboconfig)
        pause(2)
           images=grabimages(nim,1,1);
       ...
       % plot([ctconvergence ctconvergence] , histylim,'k--')
        hold off
          set(gcf,'Color','w')
         ti= title(['Histogram of quabo pixel cnts, ITER#' num2str(loopgaincnt) ' DAC1 Q0:' num2str(Q0refdac) ' Q1:' num2str(peaksrefdacQ1(1) + Q0refdac-peaksrefdacQ0(1) ) ' Q2:' num2str(peaksrefdacQ2(1) + Q0refdac-peaksrefdacQ0(1) ) ' Q3:' num2str(peaksrefdacQ3(1) + Q0refdac-peaksrefdacQ0(1) )])
         set(ti,'FontSize',14)
         xlabel('Pixel intensity [cnts per exposure]')
         ylabel('Occurence')
         saveas(gcf,['HistIma_' num2str(loopgaincnt) '_' datenow '.png'])
         saveas(gcf,['HistIma_' num2str(loopgaincnt) '_' datenow '.fig'])
           frame = getframe(gcf);
                          im = frame2im(frame); %,
                         [imind,cm] = rgb2ind(im,256);
                         delay=0.5;
                        if loopgaincnt == 1;
                             histimagename=['HistIma_' num2str(loopgaincnt) '_' datenow '.gif'];
        ...
        colorbar
          set(gcf,'Color','w')
         ti= title(['Image ITER#' num2str(loopgaincnt) ' DAC1 Q0:' num2str(Q0refdac) ' Q1:' num2str(peaksrefdacQ1(1) + Q0refdac-peaksrefdacQ0(1) ) ' Q2:' num2str(peaksrefdacQ2(1) + Q0refdac-peaksrefdacQ0(1) ) ' Q3:' num2str(peaksrefdacQ3(1) + Q0refdac-peaksrefdacQ0(1) )])
         set(ti,'FontSize',14)
        ...
        figure
        imagesc(gainmap,[gaintab-10 gaintab+10])
           %title('Gain map')
...
%petab=(1/A)*(-B + dactab);
A0=mean([peaksrefdacQ0(2)-peaksrefdacQ0(1) peaksrefdacQ0(3)-peaksrefdacQ0(2) peaksrefdacQ0(4)-peaksrefdacQ0(3)]);
A1=mean([peaksrefdacQ1(2)-peaksrefdacQ1(1) peaksrefdacQ1(3)-peaksrefdacQ1(2) peaksrefdacQ1(4)-peaksrefdacQ1(3)]);
A2=mean([peaksrefdacQ2(2)-peaksrefdacQ2(1) peaksrefdacQ2(3)-peaksrefdacQ2(2) ]); %peaksrefdacQ2(4)-peaksrefdacQ2(3)
A3=mean([peaksrefdacQ3(2)-peaksrefdacQ3(1) peaksrefdacQ3(3)-peaksrefdacQ3(2) peaksrefdacQ3(4)-peaksrefdacQ3(3)]);
...
save(['pethresh_gain' num2str(gaintab) '.mat'],'A0','A1','A2','A3','B0','B1','B2','B3')

%%% save gain map values
quaboconfig_gain=quaboconfig;
save(['gainmap_gain' num2str(gaintab) '.mat'],'gainmap','quaboconfig_gain')

...
P=zeros(numel(petab),numel(gaintab),numel(NDtab),4);
N=zeros(numel(petab),numel(gaintab),numel(NDtab),4);
TP=zeros(numel(petab),numel(gaintab),numel(NDtab),4);
%FP=zeros(numel(petab),numel(gaintab)); %si numel(indtruenano)>P
FNmissed=zeros(numel(petab),numel(gaintab),numel(NDtab),4);
duratall=zeros(numel(petab),numel(gaintab),numel(NDtab),4);
ADCmax=zeros(numel(petab),numel(gaintab),numel(NDtab),4);
ADCmean=zeros(numel(petab),numel(gaintab),numel(NDtab),4);
ADCmedian=zeros(numel(petab),numel(gaintab),numel(NDtab),4);
ADCstd=zeros(numel(petab),numel(gaintab),numel(NDtab),4);
nanosecshift=zeros(numel(petab),numel(gaintab),numel(NDtab),4);
...
if qq == 1
    maskpix1=marocmap16(9,8,:);
elseif qq == 2
    maskpix1=marocmap16(7,8,:);
    elseif qq == 3
    maskpix1=marocmap16(7,9,:);
 elseif qq == 4
    maskpix1=marocmap16(9,9,:);
end
...
%         totframes(pei,gaini)=sz1;
          duratall(pei,gaini,NDi,qq)=durat;
         P(pei,gaini,NDi,qq)=numel(ind1h);
         N(pei,gaini,NDi,qq)=sz1-numel(ind1h);
       TP(pei,gaini,NDi,qq)=truepos;
%         FP(pei,gaini)=max([numel(indtruenano)-(round(durat)+1) 0]); %si numel(indtruenano)>P
         FNmissed(pei,gaini,NDi,qq)=P(pei,gaini)-TP(pei,gaini);
         ADCmax(pei,gaini,NDi,qq)=maxhistADC;
         ADCmean(pei,gaini,NDi,qq)=meanADC;
         ADCmedian(pei,gaini,NDi,qq)=medianADC;
         ADCstd(pei,gaini,NDi,qq)=stdADC;
         nanosecshift(pei,gaini,NDi,qq)=maxhistnanosec;
%         
    end
end
end
...
for gaini = 1:numel(gaintab)
    hitrate= TP(:,gaini,NDi,qq)./P(:,gaini,NDi,qq);
...
% ylabel('Missed Rate (P-TP)/P)')
       filenm=[ 'Q' num2str(qq) 'ND' num2str(NDtab(NDi)) 'Mask' num2str(maskmode)]
...
leg={};
for gaini = 1:numel(gaintab)
   plot(phottab,squeeze(nanosecshift(pei,gaini,:,qq)),'-+','LineWidth',2)
    leg=[leg {['Gain: ' num2str(gaintab(gaini))]}]
...
set(ti, 'FontSize',12) 
filenm=['Q' num2str(qq)  'NanoShift_pe' num2str(petab(pei)) 'Mask' num2str(maskmode)]
 saveas(gcf,[newd extfile filenm '_' datenow '.png'])
 saveas(gcf,[newd extfile filenm '_' datenow '.fig'])
...
leg={};
for gaini = 1:numel(gaintab)
   plot(phottab,squeeze(ADCmax(pei,gaini,:,qq)),'-+','LineWidth',2)
    leg=[leg {['Gain: ' num2str(gaintab(gaini))]}]
...
title( ['ADC (max occur. in hist.), pe:' num2str(petab(pei)) resis ' quabo SN00' num2str(quaboSN) ', PH mode,' masklabel])
 filenm=[ 'Q' num2str(qq) 'ADCphotmax_pe' num2str(petab(pei)) 'Mask' num2str(maskmode)]
 saveas(gcf,[newd extfile filenm '_' datenow '.png'])
 saveas(gcf,[newd extfile filenm '_' datenow '.fig'])
...
leg={};
for gaini = 1:numel(gaintab)
   plot(phottab,squeeze(ADCmean(pei,gaini,:,qq)),'-+','LineWidth',2)
    leg=[leg {['Gain: ' num2str(gaintab(gaini))]}]
...
title( ['ADC (mean), pe:' num2str(petab(pei)) resis ' quabo SN00' num2str(quaboSN) ', PH mode,' masklabel])
 filenm=['Q' num2str(qq)  'ADCmean_pe' num2str(petab(pei)) 'Mask' num2str(maskmode)]
 saveas(gcf,[newd extfile filenm '_' datenow '.png'])
 saveas(gcf,[newd extfile filenm '_' datenow '.fig'])
...
leg={};
for gaini = 1:numel(gaintab)
   plot(phottab,squeeze(ADCmedian(pei,gaini,:,qq)),'-+','LineWidth',2)
    leg=[leg {['Gain: ' num2str(gaintab(gaini))]}]
...
title( ['ADC (median), pe:' num2str(petab(pei)) resis ' quabo SN00' num2str(quaboSN) ', PH mode,' masklabel])
 filenm=['Q' num2str(qq)  'ADCphotMEDIAN_pe' num2str(petab(pei)) 'Mask' num2str(maskmode)]
 saveas(gcf,[newd extfile filenm '_' datenow '.png'])
 saveas(gcf,[newd extfile filenm '_' datenow '.fig'])
...
leg={};
for gaini = 1:numel(gaintab)
   plot(phottab,squeeze(ADCstd(pei,gaini,:,qq)),'-+','LineWidth',2)
    leg=[leg {['Gain: ' num2str(gaintab(gaini))]}]
...
title( ['ADC (STD), pe:' num2str(petab(pei)) resis 'quabo SN00' num2str(quaboSN) ', PH mode,' masklabel])
 filenm=['Q' num2str(qq)  'ADCphotSTD' num2str(petab(pei)) 'Mask' num2str(maskmode)]
 saveas(gcf,[newd extfile filenm '_' datenow '.png'])
 saveas(gcf,[newd extfile filenm '_' datenow '.fig'])

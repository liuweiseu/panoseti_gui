...
dataset='Procyon3'
direc=['C:\Users\jerome\Documents\panoseti\DATA\mtlaguna_quabo1\procyon_ph\'];
...
%    text(1,1,['Distance Lens-Detector [mm]: ' num2str(pos)],'Color','y','FontSize',12)
     text(1,1,'procyion, PH, Th=238 Gain=21','Color','y','FontSize',12)
...
%     
  ...
  imagesc( (1/nbim)* totima, ([Imin Imax]))
    axis image
%    text(1,1,['Distance Lens-Detector [mm]: ' num2str(pos)],'Color','y','FontSize',12)
     text(1,1,'Averaged Procyion, PH, Th=238 Gain=21','Color','y','FontSize',12)
     %text(1,1.5,['Time comp:' datestr(timecomp(nima),'mmm.dd,yyyy HH:MM:SS.FFF') ' Packet No:' num2str(packetno(nima))],'Color','y','FontSize',12)
    cl=colorbar;
    cl.Label.String='Intensity';
    drawnow
  ...
  imagesc( (1/nbnojump)* totimanojump)
    axis image
%    text(1,1,['Distance Lens-Detector [mm]: ' num2str(pos)],'Color','y','FontSize',12)
     text(1,1,'Averaged Procyion (no jumps), PH, Th=238 Gain=21','Color','y','FontSize',12)
     %text(1,1.5,['Time comp:' datestr(timecomp(nima),'mmm.dd,yyyy HH:MM:SS.FFF') ' Packet No:' num2str(packetno(nima))],'Color','y','FontSize',12)
    cl=colorbar;
    cl.Label.String='Intensity';
    drawnow

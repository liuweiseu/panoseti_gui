...
%dark
direc='C:\Users\jerome\Documents\panoseti\DATA\darks\';
files = dir([direc 'p_d0w0m0q0_20190219_211532_42194' '*.fits']);
...
format long
     ...
     indquabo2 = find(boarloc==4661);
      ...
      plot(packetnumdiff)
      xlabel('Ima #')
      ylabel('quabo1 packet diff')
      ylim([-1 max(packetnumdiff)])
      
        packetnumdiff2=packetno2(2:end)-packetno2(1:end-1);
            subplot(2,1,2)
     plot(packetnumdiff2)
      xlabel('Ima #')
      ylabel('quabo2 packet diff')
        ylim([-1 max(packetnumdiff2)])

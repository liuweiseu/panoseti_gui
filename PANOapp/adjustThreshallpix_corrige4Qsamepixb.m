...
%         IntensmeanQ3=[IntensmeanQ3 mean(meanimage(9:16,9:16),[1 2])];
    ...
    daczeropoint1=0;threshpeak=0.35;
     if loopgaincnt==1
    peaksrefdacQ0=findpelevel(phdrefQ0,dactab,daczeropoint1,threshpeak);
     ...
     plot([peaksrefdacQ0(3) peaksrefdacQ0(3)] , yl,'g--')
      if loopgaincnt>1
           plot([peaksrefdacQ0(3)] , ctconvergence,'mo')
      end
     hold off
     ...
     if loopgaincnt>1
           plot([peaksrefdacQ0(3)+(peaksrefdacQ1(1)-peaksrefdacQ0(1))] , ctconvergence,'mo')
      end
     hold off
     subplot(2,2,3)
                hold on
     ...
     plot([peaksrefdacQ0(3)+(peaksrefdacQ2(1)-peaksrefdacQ0(1)) peaksrefdacQ0(3)+(peaksrefdacQ2(1)-peaksrefdacQ0(1))] , yl,'g--')
          ...
          if loopgaincnt>1
           plot([peaksrefdacQ0(3)+(peaksrefdacQ2(1)-peaksrefdacQ0(1))] , ctconvergence,'mo')
          end
       hold off
     subplot(2,2,4)
                hold on
     ...
     if loopgaincnt>1
           plot([peaksrefdacQ0(3)+(peaksrefdacQ3(1)-peaksrefdacQ0(1))] , ctconvergence,'mo')
      end
     hold off
    ...
    for ii=1:8
        for jj=9:16
           ...
           % peakstestdacQ0=findpelevel(phdtestQ0,dactab,daczeropoint1,threshpeak);
             ...
             [minval minindr3]= min( abs(peaksrefdacQ0(3) - dactab)); 
             if loopgaincnt==1
                 ctconvergence= phdrefQ0(minindr3);
                 %dac0convergence=peakstestdacQ0;
              end
            ...
            if numel(peakstestdacQ0)>=1
                peaksepQ0=dactab(1)-1+peakstestdacQ0(1)-peaksrefdacQ0(3);
...
%              
            ...
            if numel(peakstestdacQ1)>=1
                peaksepQ1=dactab(1)-1+peakstestdacQ1(1)-peaksrefdacQ0(3)-(peaksrefdacQ1(1)-peaksrefdacQ0(1));
...
%             peakstestdacQ2=peaksrefdacQ2(1)-1+minind;
            ...
            if numel(peakstestdacQ2)>=1
                 peaksepQ2=dactab(1)-1+peakstestdacQ2(1)-peaksrefdacQ2(1)-(peaksrefdacQ0(3)-peaksrefdacQ0(1));
...
%             peakstestdacQ3=peaksrefdacQ3(1)-1+minind;
            ...
            if numel(peakstestdacQ3)>=1
                 peaksepQ3=dactab(1)-1+peakstestdacQ3(1)-peaksrefdacQ3(1)-(peaksrefdacQ0(3)-peaksrefdacQ0(1));
    ...
    %%%%put quad at right DAC 1pe and take screenshot of image and gain map
     quaboconfig(indexdac,1+1)={['0x' dec2hex(peaksrefdacQ0(3))]};
      quaboconfig(indexdac,2+1)={['0x' dec2hex(peaksrefdacQ1(1) + peaksrefdacQ0(3)-peaksrefdacQ0(1) )]};
      quaboconfig(indexdac,3+1)={['0x' dec2hex(peaksrefdacQ2(1)+ peaksrefdacQ0(3)-peaksrefdacQ0(1))]};
       quaboconfig(indexdac,4+1)={['0x' dec2hex(peaksrefdacQ3(1)+ peaksrefdacQ0(3)-peaksrefdacQ0(1))]};
    
         disp(['Sending Maroc comm...DAC1 Q0:' num2str(peaksrefdacQ0(3))])
          disp(['Sending Maroc comm...DAC1 Q1:' num2str(peaksrefdacQ1(1) + peaksrefdacQ0(3)-peaksrefdacQ0(1) )])
           disp(['Sending Maroc comm...DAC1 Q2:' num2str(peaksrefdacQ2(1)+ peaksrefdacQ0(3)-peaksrefdacQ0(1))])
            disp(['Sending Maroc comm...DAC1 Q3:' num2str(peaksrefdacQ3(1)+ peaksrefdacQ0(3)-peaksrefdacQ0(1))])
        sendconfig2Maroc(quaboconfig)
        pause(2)
           images=grabimages(nim,1,1);
        ...
        figure
        hold on
        histogram(meanimage,64,'BinWidth',1)
        ...
        hold off
          set(gcf,'Color','w')
         ti= title(['Histogram of quabo pixel cnts, ITER#' num2str(loopgaincnt) ' DAC1 Q0:' num2str(peaksrefdacQ0(3)) ' Q1:' num2str(peaksrefdacQ1(1) + peaksrefdacQ0(3)-peaksrefdacQ0(1) ) ' Q2:' num2str(peaksrefdacQ2(1) + peaksrefdacQ0(3)-peaksrefdacQ0(1) ) ' Q3:' num2str(peaksrefdacQ3(1) + peaksrefdacQ0(3)-peaksrefdacQ0(1) )])
         set(ti,'FontSize',14)
        ...
        close
        figure
         imagesc(meanimage,[0 60])
        %title('Image')
        colorbar
          set(gcf,'Color','w')
         ti= title(['Image ITER#' num2str(loopgaincnt) ' DAC1 Q0:' num2str(peaksrefdacQ0(3)) ' Q1:' num2str(peaksrefdacQ1(1) + peaksrefdacQ0(3)-peaksrefdacQ0(1) ) ' Q2:' num2str(peaksrefdacQ2(1) + peaksrefdacQ0(3)-peaksrefdacQ0(1) ) ' Q3:' num2str(peaksrefdacQ3(1) + peaksrefdacQ0(3)-peaksrefdacQ0(1) )])
         set(ti,'FontSize',14)

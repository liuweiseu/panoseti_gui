...
%         IntensmeanQ3=[IntensmeanQ3 mean(meanimage(9:16,9:16),[1 2])];
    ...
    daczeropoint1=0;threshpeak=0.38;
     if loopgaincnt==1
    peaksrefdacQ0=findpelevel(phdrefQ0,dactab,daczeropoint1,threshpeak);
     ...
     subplot(2,2,1)
                hold on
     plot([peaksrefdacQ0(1) peaksrefdacQ0(1)] , yl,'--')
     plot([peaksrefdacQ0(2) peaksrefdacQ0(2)] , yl,'--')
     plot([peaksrefdacQ0(3) peaksrefdacQ0(3)] , yl,'--')
     hold off
     subplot(2,2,2)
                hold on
     plot([peaksrefdacQ1(1) peaksrefdacQ1(1)] , yl,'--')
     plot([peaksrefdacQ1(2) peaksrefdacQ1(2)] , yl,'--')
     plot([peaksrefdacQ1(3) peaksrefdacQ1(3)] , yl,'--')
     hold off
     subplot(2,2,3)
                hold on
     plot([peaksrefdacQ2(1) peaksrefdacQ2(1)] , yl,'--')
     plot([peaksrefdacQ2(2) peaksrefdacQ2(2)] , yl,'--')
     plot([peaksrefdacQ2(3) peaksrefdacQ2(3)] , yl,'--')
     hold off
     subplot(2,2,4)
                hold on
     plot([peaksrefdacQ3(1) peaksrefdacQ3(1)] , yl,'--')
     plot([peaksrefdacQ3(2) peaksrefdacQ3(2)] , yl,'--')
     plot([peaksrefdacQ3(3) peaksrefdacQ3(3)] , yl,'--')
     hold off
         ...
         %   if (jj~= refpixelxyQ1(1)) || (ii~= refpixelxyQ1(2))
           ...
           % peakstestdacQ1=findpelevel(phdtestQ1,dactab,daczeropoint1,threshpeak);
            ...
            if numel(peakstestdacQ1)>=1
                peaksepQ1=peakstestdacQ1(1)-peaksrefdacQ1(1)-(peaksrefdacQ0(3)-peaksrefdacQ0(1));
          ...
          %  if (jj~= refpixelxyQ2(1)) || (ii~= refpixelxyQ2(2))
           ...
           % peakstestdacQ2=findpelevel(phdtestQ2,dactab,daczeropoint1,threshpeak);
            ...
            if numel(peakstestdacQ2)>=1
                 peaksepQ2=peakstestdacQ2(1)-peaksrefdacQ2(1)-(peaksrefdacQ0(3)-peaksrefdacQ0(1));
          ...
          %  if (jj~= refpixelxyQ3(1)) || (ii~= refpixelxyQ3(2))
           ...
           % peakstestdacQ3=findpelevel(phdtestQ3,dactab,daczeropoint1,threshpeak);
            ...
            if numel(peakstestdacQ3)>=1
                 peaksepQ3=peakstestdacQ3(1)-peaksrefdacQ3(1)-(peaksrefdacQ0(3)-peaksrefdacQ0(1));

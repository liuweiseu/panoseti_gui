...
myfolder='C:\Users\User\Documents\panoseti\DATA\20200603\8\';
MyFolderInfo = dir([myfolder '*.pcapng']);
nbfiles=size(MyFolderInfo,1);


%index = find(strcmp({MyFolderInfo.name}, 'data_01616_20200604035500.pcapng')==1)
index = find(strcmp({MyFolderInfo.name}, 'data_00008_20200604033230.pcapng')==1)
file1 = MyFolderInfo(index).name;

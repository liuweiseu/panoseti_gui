...
for ii=303:304%size(quaboconfig,1)
    nbytes = fprintf(fileID,'%s\n',...
        ['*' char(quaboconfig(ii,1)) ...
      char(quaboconfig(ii,2)) ...
      char(quaboconfig(ii,3)) ...
...
for ii=305:308%size(quaboconfig,1) %HV
    if ii==305
        comm=' *';
    else
        comm='';
...
for ii=309:309%size(quaboconfig,1)
    nbytes = fprintf(fileID,'%s\n',...
        ['*' char(quaboconfig(ii,1)) ...
      char(quaboconfig(ii,2)) ...
      char(quaboconfig(ii,3)) ...
...
for ii=310:313%size(quaboconfig,1)
    nbytes = fprintf(fileID,'%s\n',...
        [char(quaboconfig(ii,1)) '='...
      char(quaboconfig(ii,2)) ' *'...
      char(quaboconfig(ii,3)) ...
...
for ii=314:315%size(quaboconfig,1)
    nbytes = fprintf(fileID,'%s\n',...
        ['*' char(quaboconfig(ii,1)) ...
      char(quaboconfig(ii,2)) ...
      char(quaboconfig(ii,3)) ...
...
for ii=316:319%size(quaboconfig,1)
    nbytes = fprintf(fileID,'%s\n',...
        [char(quaboconfig(ii,1)) '='...
      char(quaboconfig(ii,2)) ' *'...
      char(quaboconfig(ii,3)) ...
...
for ii=320:325%size(quaboconfig,1)
    nbytes = fprintf(fileID,'%s\n',...
        ['*' char(quaboconfig(ii,1)) ...
      char(quaboconfig(ii,2)) ...
      char(quaboconfig(ii,3)) ...
...
for ii=326:334%size(quaboconfig,1)
    nbytes = fprintf(fileID,'%s\n',...
        [char(quaboconfig(ii,1)) '='...
      char(quaboconfig(ii,2)) ' *'...
      char(quaboconfig(ii,3)) ...

...
#v03 added store_in_pixel_order option so we can write the data to the file in the order it appears in the image
...
#Set this to store the pixel data in the order in which it arrives, so column 0, then column 1, etc
...
logfilename = ".\sweep\quabo_sweep.csv"
...
while (1):
    ...
    if thresh != old_thresh:
        ...
        chip2=[]
        chip3=[]
        #The data come in 64 from Column 0, then column 1, etc
        for n in range(256):
